...
const META_PIXEL_ID=process.env.NEXT_PUBLIC_META_PIXEL_ID||'2157751575617005';
...
export function trackMetaEvent(event:string,parameters:Record<string,unknown>,eventId?:string){
